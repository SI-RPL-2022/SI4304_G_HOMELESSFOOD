...
<div class="container">
	...
	<form class="mt-4" method="POST" action="/homeless/insert" enctype="multipart/form-data">
	  @csrf
	  <div class="row">
	  	<div class="col-md-8">
	  		<div class="row">
				...
				<div class="form-group col-md-4">
					...
					<select class="form-control" required="" id="cities">
						...
						<option value="161">Bandung</option>
					</select>
					<small id="helper_cities"></small>
				</div>
				<div class="form-group col-md-4">
					<label>Kecamatan</label>
					<select class="form-control region" id="dis" required="" disabled="">
				...
				<div class="form-group col-md-4">
					...
					<select class="form-control region" id="subdis" required="" disabled="" name="subdis_id">
						<option>Silahkan pilih kota</option>
					</select>
				...
				<div class="form-group col-md-12">
					...
					<textarea autocomplete="off" class="form-control" required="" name="location_detail"></textarea>
				</div>
	  		</div>
	  	</div>
	  	<div class="col-md-4">
	  		<div class="row">
		  		...
		  		<div class="form-group col-md-12" style="margin-top:-6px">
			  		...
			  		<input required autocomplete="off" name="total_count" type="number" class="form-control">
		  		</div>

		  		<div class="form-group col-md-12">
					<label>Ciri - Ciri</label>
					<textarea autocomplete="off" class="form-control" required="" name="characteristic"></textarea>
				</div>
			</div>
	  	</div>
	  </div>
